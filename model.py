...
def modelo(df_notas):
    ...
    model += lpSum([cant_unidades[id_nota, id_producto] <=  nota_completa[id_nota, id_producto] * df_notas.loc[(id_nota, id_producto), 'cantidad'].sum() for id_nota, id_producto in df_notas.index]), "c2"
    model += lpSum([cant_unidades[id_nota, id_producto] <=  nota_modificada[id_nota, id_producto] * df_notas.loc[(id_nota, id_producto), 'cantidad'].sum() for id_nota, id_producto in df_notas.index]), "c3" 
